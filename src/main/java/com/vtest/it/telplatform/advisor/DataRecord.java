...
import com.vtest.it.telplatform.services.FailDieCheck.AdjacentFailDieCheck;
import com.vtest.it.telplatform.services.prober.impl.ProberServicesImpl;
import com.vtest.it.telplatform.services.rawdatatools.GenerateVtptmtWaferInforBean;
import com.vtest.it.telplatform.services.urlMesInformation.WaferIdBinSummaryWrite;
import com.vtest.it.telplatform.services.vtptmt.impl.VtptmtInforImpl;
import com.vtest.it.telplatform.services.vtptmt.impl.VtptmtServices;
...
public class DataRecord {
    ...
    @Pointcut(value = "execution(* generateTempRawdata(..))&&target(com.vtest.it.telplatform.services.rawdatatools.GenerateRawdataTemp)")
