package com.vtest.it.telplatform.configuration;
...
@Configuration
@MapperScan(basePackages = {"com.vtest.it.telplatform.dao.prober"},sqlSessionTemplateRef ="probermtSqlsessionTemplate")
